(function () {
    ...
    const styles = `
        ...
        :root {
            /* Branding Oclinhos de Leitura — azul-marinho da marca #0e3b65 */
            --c-bg: #ffffff;
            --c-surface: #eef2f7;
            --c-ink: #0e3b65;        /* azul da marca (CTAs, títulos, texto, ênfase) */
            --c-ink-text: #0e3b65;   /* mesmo azul da marca (provador todo naquele azul) */
            --c-muted: #7d8896;
            --c-line: #d8e0ea;
        ...
        .q-btn-trigger-ia {
            position: absolute; top: 8px; left: 14px; right: auto; z-index: 100;
        ...
        @media (min-width: 768px) { .q-btn-trigger-ia { width: 72px; height: 72px; top: 8px; right: 14px; left: auto; } }
        ...
        .q-provas-msg {
            font-size: 13px; margin-top: 14px; letter-spacing: 0.4px;
        ...
        /* ── Ajuste SO mobile: as FONTES ficam iguais as da Cacife (base, sem
